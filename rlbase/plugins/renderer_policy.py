...
from ..core import Model,Plugin, Transition, Action, POLICY_COLOR
...
class PolicyRenderer(Plugin):
    def __init__(self,
        ...
        self._model.ext_data['pi'] = np.ones((model.nS, model.nA))/model.nA
    ...
    def reset(self):
        self._enable=True
        model=self._model
        model.ext_data['pi'] = np.ones((model.nS, model.nA))/model.nA